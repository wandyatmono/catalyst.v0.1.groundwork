...
Walau demikian hanya ada satu (yang berukuran 128px yang dipasang di sini, demi efisiensi). Selama tidak ada issue report di devices, untuk sementara tidak dibuatkan berbagai ukuran favicon seperti pada teori.
